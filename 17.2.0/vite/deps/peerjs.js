          ...
          switch (_b2.label) {
            ...
            case 14:
              ...
              if (!(stream_2_1 && !stream_2_1.done && (_a2 = stream_2.return)))
                return [3, 16];
              return [4, __await2(_a2.call(stream_2))];
            case 15:
              _b2.sent();
              _b2.label = 16;
            case 16:
...
function asyncIterableFromStream(stream) {
  return __asyncGenerator3(this, arguments, function asyncIterableFromStream_1() {
...
var $dcf98445f54823f4$var$iterateOver = function(stream) {
  return __asyncGenerator(this, null, function* () {
...
var $dcf98445f54823f4$export$7e9583c3c8a0a2cc = class extends (0, $20dbe68149d7aad9$export$72aa44612e2200cd) {
  constructor(peerId, provider, options) {
    ...
    (() => __async(this, null, function* () {
      try {
        for (var iter = __forAwait($dcf98445f54823f4$var$iterateOver(this._decoderStream.readable)), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
